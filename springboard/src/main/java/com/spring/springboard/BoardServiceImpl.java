...
public class BoardServiceImpl implements BoardService{
	...
	public BoardVO updateGetArticle(int num) throws Exception {
		try {
			BoardVO vo = boardDAO.updateGetArticle(num);
			return vo;
		}catch(Exception e) {
			throw new Exception("수정 선택 글 검색 실패");
		}
	}
